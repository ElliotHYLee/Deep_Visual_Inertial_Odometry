...
H = eye(3);
P{1} = eye(3)*10^-10;
R = [10^-6.5 10^-6.64 10^-6; 
    10^-6.64 10^-5.4 10^-5.1;
    10^-6 10^-5.1 10^-4.5]
% airsim
...
% R = [3.5266962e-06 -0.0000000e+00 -0.0000000e+00;
%  -0.0000000e+00  9.4789120e-06 -0.0000000e+00;
%  -0.0000000e+00 -0.0000000e+00  3.6985199e-05]
for i=1:1:N
