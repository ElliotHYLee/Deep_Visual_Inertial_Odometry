...
strTitle = strcat(dsName, {' '}, 'Sequence', {' '}, int2str(seq));
...
zlabel('Position_Z, m', 'fontsize', 14)
...
plot(gt_du(:,1), 'r.')
% ylim([-0.1, 2])
ylabel('\DeltaU_X, m', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
title('Tranlational Movement')
subplot(6,2,4)
plot(gt_du(:,2), 'r.')
ylabel('\DeltaU_Y, m', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
subplot(6,2,6)
plot(gt_du(:,3), 'r.')
ylabel('\DeltaU_Z, m', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)

subplot(6,2,7)
plot(gt_dw(:,1), 'r.')
ylabel('\DeltaW_X, rad', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
title('Angular Displacement')
subplot(6,2,9)
plot(gt_dw(:,2), 'r.')
ylabel('\DeltaW_Y, rad', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
subplot(6,2,11)
plot(gt_dw(:,3), 'r.')
ylabel('\DeltaW_Z, rad', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
 
subplot(6,2,8)
plot(gt_dtr(:,1), 'r.')
ylabel('\DeltaVu_X, m', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
% ylim([-0.1, 2])
title('Overall Displacement')
subplot(6,2,10)
plot(gt_dtr(:,2), 'r.')
ylabel('\DeltaVu_Y, m', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
subplot(6,2,12)
plot(gt_dtr(:,3), 'r.')
ylabel('\DeltaVu_Z, m', 'fontsize', 14)
xlabel('Data Points', 'fontsize', 14)
